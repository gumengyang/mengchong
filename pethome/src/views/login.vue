    ...
    <div>
        ...
        <main class="text-center">
            <div class="login">
                ...
                <div>
                    <input placeholder="请输入用户名" id="uname" v-model="uname" @blur="unameblur" @focus="unamefocus">
                    <span id="utxt">请输入3~12位数字或字母，不能以数字开头</span>
                </div>
                <div>
                    <input type="password" placeholder="请输入密码" v-model="upwd" id="upwd" @focus="upwdfocus" @blur="upwdblur">
                    <span id="ptxt">请输入6~12位数字或字母</span>
                </div>
                <div>
                    <input placeholder="请输入验证码" id="test" v-model="reg" @blur="testblur">
                    <span id="ttest"></span>
                </div>
